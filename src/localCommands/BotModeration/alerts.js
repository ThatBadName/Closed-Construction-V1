    ...
    async execute(
        ...
        if (interaction.options.getString('id')) {
            ...
            if (searchResults.length === 0) return wait.edit({
                embeds: [new EmbedBuilder().setColor(16777215).setTitle('No commands have been run in the past 24 hours')],
                fetchReply: true
            })
            ...
            const firstEmbed = await wait.edit({
                ...
                return wait.edit({
                    embeds: [new EmbedBuilder().setColor(16777215).setTitle('No alerts with that ID')],
                    fetchReply: true
                })
            })
            ...
            const firstEmbed = await wait.edit({
                ...
                return wait.edit({
                    embeds: [new EmbedBuilder().setColor(16777215).setTitle('This user has not used any commands in the past 24 hours')],
                    fetchReply: true
                })
            })
            ...
            if (interaction.options.getBoolean('flagged') === true && !interaction.options.getBoolean('staff-command')) commands = await recentCommands.find({
                command: {$regex: interaction.options.getString('command')},
                suspicious: true
            }).sort({
                _id: -1
            })
            ...
            const firstEmbed = await wait.edit({
                ...
                return wait.edit({
                    embeds: [new EmbedBuilder().setColor(16777215).setTitle('There has been no usage of this command in the past 24 hours')],
                    fetchReply: true
                })
            })
            ...
            const firstEmbed = await wait.edit({
                ...
                return wait.edit({
                    embeds: [new EmbedBuilder().setColor(16777215).setTitle('I could not find any results for these search queries')],
                    fetchReply: true
                })
            })
