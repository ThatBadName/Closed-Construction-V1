        ...
        switch (action) {
                ...
                if (interaction.options.getString('type') === 'guild') {
                    ...
                    const firstEmbed = await interaction.reply({
                        ...
                        return interaction.reply({
                            embeds: [new EmbedBuilder().setColor(16777215).setTitle('This blacklist is empty')],
                            fetchReply: true
                        })
                    })
            ...
            case "add":
                ...
                if (interaction.options.getString('type') === 'guild') {
                    ...
                    if (check) return interaction.reply({
                        embeds: [new EmbedBuilder().setTitle('This user is already on the blacklist').setColor(16777215)]
                    })
                    if (check2) return interaction.reply({
                        embeds: [new EmbedBuilder().setTitle('This ID has been found in the guilds blacklist').setColor(16777215)]
                    })
                    if (interaction.options.getString('duration')) {
                        let time
                        let type
