        ...
        if (interaction.options.getSubcommand() === 'dev') {
            ...
            const firstEmbed = await omgSoLongMsg.edit({
                ...
                return omgSoLongMsg.edit({
                    embeds: [new EmbedBuilder().setColor(16777215).setTitle('Inventory is empty')],
                    fetchReply: true
                })
            })
            ...
            const firstEmbed = await omgSoLongMsg.edit({
                ...
                return omgSoLongMsg.edit({
                    embeds: [new EmbedBuilder().setColor(16777215).setTitle('There are no reports for this criteria')],
                    fetchReply: true
                })
            })
            ...
            const firstEmbed = await omgSoLongMsg.edit({
                ...
                return omgSoLongMsg.edit({
                    embeds: [new EmbedBuilder().setColor(16777215).setTitle('I could not find any codes going with this criteria')],
                    fetchReply: true
                })
            })
