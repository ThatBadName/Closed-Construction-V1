        ...
        if (interaction.options.getSubcommand() === 'dev') {
            ...
            if (type === 'coins-wallet') {
                ...
                if (!userProfile) {
                    ...
                    userProfile.dailyStreak = amount
                    await userProfile.save()
                    return interaction.reply({
                        embeds: [
                            new EmbedBuilder()
                            .setTitle('Set daily streaks')
                            .setColor(colours.blend)
                            .setFields({
                                name: 'User',
                                value: `<@${userID}> (\`${userID}\`)`
            ...
            const firstEmbed = await omgSoLongMsg.edit({
                ...
                return omgSoLongMsg.edit({
                    embeds: [new EmbedBuilder().setColor(colours.blend).setTitle('Inventory is empty')],
                    fetchReply: true
                })
            })
            ...
            const firstEmbed = await omgSoLongMsg.edit({
                ...
                return omgSoLongMsg.edit({
                    embeds: [new EmbedBuilder().setColor(colours.blend).setTitle('There are no reports for this criteria')],
                    fetchReply: true
                })
            })
            ...
            const firstEmbed = await omgSoLongMsg.edit({
                ...
                return omgSoLongMsg.edit({
                    embeds: [new EmbedBuilder().setColor(colours.blend).setTitle('I could not find any codes going with this criteria')],
                    fetchReply: true
                })
            })
