...
module.exports = {
    ...
    async execute(
        ...
        if (interaction.options.getSubcommand() === 'view') {
            ...
            if (!profile && interaction.user.id === userToView.id) {
                ...
                const profileEmbed = new EmbedBuilder()
                    ...
                    .setDescription(`**Bio:** ${newProfile.bio}\n**Badges:** None\n**Commands Run**: ${newProfile.commandsRun.toLocaleString()}\n${newProfile.job !== '' ? `Works as a \`${newProfile.job}\`` : ''}`)
                    .setFields({
                        name: 'Level',
                        value: `Bot Level: \`${newProfile.level.toLocaleString()}\`\nPlanet Level: \`${newProfile.planetLevel.toLocaleString()}\`\nShifts: \`${newProfile.shifts.toLocaleString()}\`\nDaily Streak: \`${newProfile.dailyStreak.toLocaleString()}\``,
                        inline: true
                    }, {
                        name: 'XP',
                        value: `Bot XP: \`${newProfile.xp.toLocaleString()}/${newProfile.requiredXp.toLocaleString()}\` (\`${Math.round(newProfile.xp / newProfile.requiredXp * 100)}%\`)\nPlanet XP: \`${newProfile.planetXp.toLocaleString()}/${newProfile.requiredPlanetXp.toLocaleString()}\` (\`${Math.round(newProfile.planetXp / newProfile.requiredPlanetXp * 100)}%\`)`,
                        inline: true
                    }, {
                        name: 'Balance',
                ...
                if (!profile) {
                    ...
                    const profileEmbed = new EmbedBuilder()
                        ...
                        .setTitle(`${userToView.username}'s profile`)
                        .setDescription(`**Bio:** ${profile.bio}\n**Badges:** ${invItems.length === 0 ? 'None' : invItems}\n**Rank**: ${profile.developer === true ? '<:DeveloperBadge:1006817283550761051> Developer' : `${profile.botAdmin === true ? '<:AdminBadge:1006817282061762570> Bot Admin' : `${profile.botModerator === true ? '<:ModeratorBadge:1006817284846792765> Bot Moderator' : 'Regular'}`}`}\n**Commands Run**: ${profile.commandsRun.toLocaleString()}\n${profile.job !== '' ? `Works as a \`${profile.job}\`` : ''}`)
                        .setFields({
                            name: 'Level',
                            value: `Bot Level: \`${profile.level.toLocaleString()}\`\nPlanet Level: \`${profile.planetLevel.toLocaleString()}\`\nShifts: \`${profile.shifts.toLocaleString()}\`\nDaily Streak: \`${profile.dailyStreak.toLocaleString()}\``,
                            inline: true
                        }, {
                            name: 'XP',
                            value: `Bot XP: \`${profile.xp.toLocaleString()}/${profile.requiredXp.toLocaleString()}\` (\`${Math.round(profile.xp / profile.requiredXp * 100)}%\`)\nPlanet XP: \`${profile.planetXp.toLocaleString()}/${profile.requiredPlanetXp.toLocaleString()}\` (\`${Math.round(profile.planetXp / profile.requiredPlanetXp * 100)}%\`)`,
                            inline: true
                        }, {
                            name: 'Balance',
            ...
            collector.on('collect', async (i) => {
                ...
                if (i.customId === 'bio') {
                    ...
                    if (!result) userProfile = await profileSchema.create({
                        userId: interaction.user.id
                    })
                    ...
                    if (userProfile.unlockedPlanetLevel >= 1 && userProfile.currentPlanet !== 'Earth') planetButtons1.addComponents(new ButtonBuilder().setLabel('Earth').setStyle('Secondary').setCustomId('earth'))
                    else planetButtons1.addComponents(new ButtonBuilder().setLabel('Earth').setStyle('Secondary').setCustomId('earth').setDisabled(true))

                    if (userProfile.unlockedPlanetLevel >= 2 && userProfile.currentPlanet !== 'Mars') planetButtons1.addComponents(new ButtonBuilder().setLabel('Mars').setStyle('Secondary').setCustomId('mars'))
                    else planetButtons1.addComponents(new ButtonBuilder().setLabel('Mars').setStyle('Secondary').setCustomId('mars').setDisabled(true))

                    if (userProfile.unlockedPlanetLevel >= 3 && userProfile.currentPlanet !== 'Iversium') planetButtons1.addComponents(new ButtonBuilder().setLabel('Iversium').setStyle('Secondary').setCustomId('iversium'))
                    ...
                    if (userProfile.unlockedPlanetLevel >= 4 && userProfile.currentPlanet !== 'Inversion') planetButtons1.addComponents(new ButtonBuilder().setLabel('Inversion').setStyle('Secondary').setCustomId('inversion'))
                    ...
                    if (userProfile.unlockedPlanetLevel >= 5 && userProfile.currentPlanet !== 'SchlasttTone') planetButtons1.addComponents(new ButtonBuilder().setLabel('SchlasttTone').setStyle('Secondary').setCustomId('schlastttone'))
                    ...
                    if (userProfile.unlockedPlanetLevel >= 6 && userProfile.currentPlanet !== 'Polaris') planetButtons2.addComponents(new ButtonBuilder().setLabel('Polaris').setStyle('Secondary').setCustomId('polaris'))
                    ...
                    if (userProfile.unlockedPlanetLevel >= 7 && userProfile.currentPlanet !== 'Cycnus') planetButtons2.addComponents(new ButtonBuilder().setLabel('Cycnus').setStyle('Secondary').setCustomId('cycnus'))
                    ...
                    if (userProfile.unlockedPlanetLevel >= 8 && userProfile.currentPlanet !== 'Ascalaphus') planetButtons2.addComponents(new ButtonBuilder().setLabel('Ascalaphus').setStyle('Secondary').setCustomId('ascalaphus'))
                    ...
                    if (userProfile.unlockedPlanetLevel >= 9 && userProfile.currentPlanet !== 'Minerva') planetButtons2.addComponents(new ButtonBuilder().setLabel('Minerva').setStyle('Secondary').setCustomId('minerva'))
                    ...
                    if (userProfile.unlockedPlanetLevel >= 10 && userProfile.currentPlanet !== 'Nestor') planetButtons2.addComponents(new ButtonBuilder().setLabel('Nestor').setStyle('Secondary').setCustomId('nestor'))
                    ...
                    if (userProfile.unlockedPlanetLevel >= 11 && userProfile.currentPlanet !== 'Hesperus') planetButtons3.addComponents(new ButtonBuilder().setLabel('Hesperus').setStyle('Secondary').setCustomId('hesperus'))
                    ...
                    if (userProfile.unlockedPlanetLevel >= 12 && userProfile.currentPlanet !== 'Ceyx') planetButtons3.addComponents(new ButtonBuilder().setLabel('Ceyx').setStyle('Secondary').setCustomId('ceyx'))
                    else planetButtons3.addComponents(new ButtonBuilder().setLabel('Ceyx').setStyle('Secondary').setCustomId('ceyx').setDisabled(true))

                    if (userProfile.unlockedPlanetLevel >= 13 && userProfile.currentPlanet !== 'Vesta') planetButtons3.addComponents(new ButtonBuilder().setLabel('Vesta').setStyle('Secondary').setCustomId('vesta'))
                    else planetButtons3.addComponents(new ButtonBuilder().setLabel('Vesta').setStyle('Secondary').setCustomId('vesta').setDisabled(true))

                    if (userProfile.unlockedPlanetLevel >= 14 && userProfile.currentPlanet !== 'Pirithous') planetButtons3.addComponents(new ButtonBuilder().setLabel('Pirithous').setStyle('Secondary').setCustomId('pirithous'))
                    ...
                    if (userProfile.unlockedPlanetLevel >= 15 && userProfile.currentPlanet !== 'Bad\'s Kingdom') planetButtons3.addComponents(new ButtonBuilder().setLabel('Bad\'s Kingdom').setStyle('Secondary').setCustomId('bad-kingdom'))
