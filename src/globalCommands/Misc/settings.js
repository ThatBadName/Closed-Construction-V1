        ...
        if (userProfile.developer === true) {
                ...
                .addComponents(
                    ...
                    .addOptions([{
                        ...
                        },
                        {
                            ...
                            description: 'Disable this to hide yourself from public leaderboards',
                            value: 'lb',
                        }
                    ]),
                )
            ...
            collector.on('collect', async (i) => {
                ...
                if (i.customId === 'enable') {
                    ...
                    if (currentSetting === 'lb') userProfile.showOnLeaderboards = true
                    ...
                    if (currentSetting === 'lb') userProfile.showOnLeaderboards = false
                    if (currentSetting === 'passive') {
                        const checkForPassive = await passiveCooldownSchema.findOne({
                            userId: interaction.user.id
                        })
                    ...
                    if (i.values[0] === 'devmode') {
                        ...
                        collector.resetTimer()
                        i.deferUpdate()
                    } else if (i.values[0] === 'lb') {
                        currentSetting = 'lb'
                        settingsEmbed.setTitle('Show On Leaderboards')
                            .setDescription('Disable this to hide yourself from public leaderboards')
                        if (userProfile.voteReminders === false) {
                            buttons.components[0].setDisabled(false)
                            buttons.components[1].setDisabled(true)
                        } else {
