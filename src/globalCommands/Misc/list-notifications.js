        ...
        if (interaction.options.getString('show')) {
            ...
            if (commandEmbeds.length === 1) {
                ...
                firstEmbed = await wait.edit({
                    ...
                    return wait.edit({
                        embeds: [new EmbedBuilder().setColor(16777215).setTitle('No notifications with that ID')],
                        fetchReply: true
                    })
                })
            } else if (commandEmbeds.length === 0) {
                    return wait.edit({
                        embeds: [new EmbedBuilder().setColor(16777215).setTitle('No notifications with that ID')],
                        fetchReply: true
                    })
            ...
            if (commandEmbeds.length === 0) {
                    return wait.edit({
                        embeds: [new EmbedBuilder().setColor(16777215).setTitle('You have no notifications')],
                        fetchReply: true
                    })
            } else {
                firstEmbed = await wait.edit({
